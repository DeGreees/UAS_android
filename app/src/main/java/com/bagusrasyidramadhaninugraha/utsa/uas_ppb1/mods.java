...
public class mods extends AppCompatActivity {
    ...
    private void prosesRecyclerViewAdapter(){
        ...
        adaptermod adapter = new adaptermod(gambarmod, namamod, hargamod,this);
