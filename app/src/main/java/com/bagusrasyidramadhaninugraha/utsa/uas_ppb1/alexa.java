...
public class alexa extends AppCompatActivity {
    ...
    Button button;
    EditText editnama, editalamat, editbarang, editpesanrda2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alexa);
        editnama = findViewById(R.id.namplgrda2);
        editalamat = findViewById(R.id.alamatplgrda2);
        editbarang = findViewById(R.id.jmlbrgrda2);
        editpesanrda2 = findViewById(R.id.editpesanrda2);

        button = findViewById(R.id.btnkirimrda2);
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                String pesan4 = editpesanrda2.getText().toString();
